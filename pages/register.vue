  ...
  <div class="dark:bg-slate-800 h-screen">
    <div class="flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full">
        <div class="flex">
          <img class="mx-auto h-24 w-auto" src="/img/logo_clear_fsj.png" alt="full stack project"/>
          <h1 class="py-9 text-center text-5xl font-semibold text-gray-900 dark:text-gray-300">
            Full Stack Sami
          </h1>
        </div>
